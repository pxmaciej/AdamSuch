    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-12 col-md-12 event-block">
                <div class="event-block-one wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image-box"><a href="event-details.html"><img src="images/resource/event-5.jpg" alt=""></a></figure>
                        <div class="content-box">
                            <div class="date">15 July, 2019</div>
                            <h3><a href="event-details.html">Drawing & Painting</a></h3>
                            <div class="text">Lorem ipsum dolor amet consectur pisicelit sed eiusmod tempor indie</div>
                            <div class="location"><i class="flaticon-pin"></i>Location: <span>NEW YORK</span></div>
                        </div>
                    </div>
            ...
            <div class="col-xl-6 col-lg-12 col-md-12 event-block">
                <div class="event-block-one wow fadeInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image-box"><a href="event-details.html"><img src="images/resource/event-6.jpg" alt=""></a></figure>
                        <div class="content-box">
                            <div class="date">17 July, 2019</div>
                            <h3><a href="event-details.html">Color Matching</a></h3>
                            <div class="text">Lorem ipsum dolor amet consectur pisicelit sed eiusmod tempor indie</div>
                            <div class="location"><i class="flaticon-pin"></i>Location: <span>NEW YORK</span></div>
                        </div>
                    </div>
