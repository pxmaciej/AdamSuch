        ...
        <?php $__empty_1 = true; $__currentLoopData = $savedevents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-xl-6 col-lg-12 col-md-12 event-block">
                    <div class="event-block-one wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="event-details.html"><img src="storage/events/<?php echo e($event->img_name); ?>" alt=""></a></figure>
                            <div class="content-box">
                        ...
                        <ul class="accordion-box active-block">
                            <li class="accordion block">
                                ...
                                <div class="acc-content current">
                                    <div class="content">
                                        <div class="text">Wybierz zakładkę zajęcia i przejdź do tych które cię interesują. Zostaniesz przekierowany do zakładki podsumowującej zakup i za pomocą przelew24 szybko zrealizujesz płatność.</div>
                                    </div>
                                </div>
                            </li>
                            <li class="accordion block">
                                ...
                                <div class="acc-content">
                                    <div class="content">
                                        <div class="text">Dostęp jest przyznawany na okres 24 godzin.</div>
                                    </div>
                                </div>
                            </li>
                            <li class="accordion block">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/test/Documents/work/AdamSuch/resources/views/pages/home.blade.php ENDPATH**/ ?>